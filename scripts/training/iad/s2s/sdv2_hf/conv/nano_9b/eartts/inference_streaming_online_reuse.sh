...
WANDB="29856e498944d0e7f5445f6d8596d0b23ebadda1" # replace with your own WandB API key
...
CODE_DIR=/lustre/fsw/portfolios/llmservice/users/kevinhu/code/s2s_pretrain_20251022_merge/NeMo
...
MODEL_PATH=/lustre/fsw/portfolios/convai/users/ecasanova/S2S-Duplex-new-codebase/results/exp/nov25/exp_SFT_9b/IAD_Nano-9B_SFT_Parakeet600m_asr_sp_from_checkpoints_hf_32002_64gpu_PT0.7_SFT0.05_QA0.02_TEXT0.1_MCQ0.03_ASR0.01_SP0.01_LR5e-5_na0.5-30-60_ci_sa15_la2_tls5.0_facuda_val1000.v2_digits_norm_approved_sft_R_eip_0.1/checkpoints_hf_9005
...
python /lustre/fsw/portfolios/convai/users/kevinhu/S2S-Duplex-new-codebase/scripts/eartts/inference_streaming_online_reuse.py \
