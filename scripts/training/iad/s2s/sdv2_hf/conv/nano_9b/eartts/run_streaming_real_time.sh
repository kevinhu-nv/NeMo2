...
# audio_path=/lustre/fsw/portfolios/llmservice/users/kevinhu/data/elena_20251120/moshi_client_input_sf.wav
# audio_path=/lustre/fsw/portfolios/llmservice/users/kevinhu/data/elena_20251120/moshi_client_input_maths.wav
...
# Extract the last subdir of MODEL_PATH to add as a subdir to RESULTS_DIR
