...
root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/${dataset_name}
target_tar_dir=/lustre/fsw/portfolios/llmservice/projects/llmservice_nemo_speechlm/data/s2s_synthetic_data/${dataset_name}/${dataset_name}
source_tar_dir=/lustre/fsw/portfolios/llmservice/projects/llmservice_nemo_speechlm/data/s2s_synthetic_data/${dataset_name}/raw_manifests


RESULTS_DIR=${root_dir}/log
mkdir -p $RESULTS_DIR
input_manifest_dir=${root_dir}
...
&& HYDRA_FULL_ERROR=1 TORCH_CUDNN_V8_API_ENABLED=1 python -u -B create_shars_from_single_turn.py \
