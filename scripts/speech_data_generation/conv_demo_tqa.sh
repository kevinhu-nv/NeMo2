...
val_data=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_validation/shar_duplex/manifest_000000
...
id=$(ls ${gen_wav_dir}/0_*.gen.wav | awk -F'/' '{print $NF}' | grep -oE '^0_[^.]+' | shuf -n 1)
