...
# #SBATCH -J "convai_convaird_nemo-speech-speechllm:data_duplex_4turn"
#SBATCH -p cpu_short
...
#SBATCH -J "llmservice_nemo_speechlm:data_duplex_4turn"
...
&& HYDRA_FULL_ERROR=1 TORCH_CUDNN_V8_API_ENABLED=1 python -u -B create_shars_duplex_4turn_from_shar.py \
--in_dir=${in_dir} \
