...
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_validation/shar_duplex_1turn/source_align
...
in_shar_dir=${llm_root_dir}/manifest_${manifest_index}
ctm_dir=${user_root_dir}/manifest_${manifest_index}
num_shard=10
