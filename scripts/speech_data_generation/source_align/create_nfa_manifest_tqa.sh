...
#SBATCH -J "convai_convaird_nemo-speech-speechllm:create_nfa_manifest_tqa"
#SBATCH -p cpu_short
...
# #SBATCH -J "llmservice_nemo_speechlm:create_nfa_manifest_tqa"
...
# llm_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_validation/shar_duplex/
# llm_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_validation/shar_duplex_1turn
# llm_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_web_train/shar_duplex/
llm_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_unfiltered_train/shar_duplex/
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/s2s/data_duplex/Mixtral8x22b_MMLPC_en
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_train/shar_duplex/source_align
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_validation/shar_duplex/source_align
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_validation/shar_duplex_1turn/
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_web_train/shar_duplex/source_align
user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_unfiltered_train/shar_duplex/source_align
...
in_shar_dir=${llm_root_dir}/manifest_${shar_index}
output_audio_dir=${user_root_dir}/manifest_${shar_index}/recording
output_manifest_dir=${user_root_dir}/manifest_${shar_index}/
