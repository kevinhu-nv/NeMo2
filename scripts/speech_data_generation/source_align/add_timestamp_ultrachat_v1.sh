...
#SBATCH -J "convai_convaird_nemo-speech-speechllm:add_timestamp_ultrachat_v1"
#SBATCH -p cpu_short
...
# #SBATCH -J "llmservice_nemo_speechlm:add_timestamp"
...
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/ultrachat_v2/shar_duplex/source_align
user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/ultrachat/shar_duplex/source_align
