...
llm_root_dir=/lustre/fsw/portfolios/llmservice/projects/llmservice_nemo_speechlm/data/duplex/nvolve_chatqa/
# user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/s2s/data_duplex/Mixtral8x22b_MMLPC_en
user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/nvolve_chatqa/shar_duplex
