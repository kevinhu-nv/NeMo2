...
# #SBATCH -J "llmservice_nemo_speechlm:tqa_nfa"
...
# manifest_dir=${root_dir}/triviaqa_train/shar_duplex/source_align/manifest_$(printf "%06d" ${manifest_index})
# manifest_dir=${root_dir}/triviaqa_validation/shar_duplex/source_align/manifest_$(printf "%06d" ${manifest_index})
# manifest_dir=${root_dir}/triviaqa_validation/shar_duplex_1turn/source_align/manifest_$(printf "%06d" ${manifest_index})
# manifest_dir=${root_dir}/triviaqa_web_train/shar_duplex/source_align/manifest_$(printf "%06d" ${manifest_index})
manifest_dir=${root_dir}/triviaqa_unfiltered_train/shar_duplex/source_align/manifest_$(printf "%06d" ${manifest_index})
