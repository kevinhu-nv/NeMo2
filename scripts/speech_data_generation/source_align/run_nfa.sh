...
#SBATCH -J "convai_convaird_nemo-speech:Mixstral_nfa"
...
manifest_index="$1"
root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/s2s/data_duplex
manifest_dir=${root_dir}/Mixtral8x22b_MMLPC_en/manifest_${manifest_index}
