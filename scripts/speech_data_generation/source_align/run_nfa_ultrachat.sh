...
#SBATCH -J "convai_convaird_nemo-speech:ultrachat_nfa"
...
# manifest_dir=${root_dir}/ultrachat_v2/shar_duplex/source_align/manifest_$(printf "%06d" ${manifest_index})
manifest_dir=${root_dir}/ultrachat/shar_duplex/source_align/manifest_$(printf "%06d" ${manifest_index})
