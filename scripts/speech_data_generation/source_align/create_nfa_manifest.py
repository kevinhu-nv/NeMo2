...
def parse_args():
    ...
    parser.add_argument("--output_audio_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/s2s/data_duplex/Mixtral8x22b_MMLPC_en/manifest_0/recording")
