...
#SBATCH -J "convai_convaird_nemo-speech-speechllm:add_timestamp_topic"
#SBATCH -p cpu_short
...
user_root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex//topic_v2/Meta-Llama-3.1-70B-Instruct/shar_duplex/source_align
