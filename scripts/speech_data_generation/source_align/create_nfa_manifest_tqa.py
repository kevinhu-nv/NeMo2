...
def parse_args():
    ...
    parser.add_argument("--in_shar_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_train/shar_duplex/manifest_000000")
    parser.add_argument("--output_audio_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_train/shar_duplex/manifest_000000/recording")
    parser.add_argument("--output_manifest_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/triviaqa_train/shar_duplex/manifest_000000")
