...
# manifest_dir=${root_dir}/340b_8.19_daring_anteater_synth_v2_prompts_8801rm3.7p/shar_duplex
manifest_dir=${root_dir}/340b_8.19_daring_anteater_lmsys_sft_8801rm3.7p/shar_duplex
...
OUTFILE=${RESULTS_DIR}/slurm-%j-align-%n.out
ERRFILE=${RESULTS_DIR}/error-%j-align-%n.out
srun -o $OUTFILE -e $ERRFILE --container-image="$CONTAINER" $MOUNTS bash -c "${cmd}"

# ./autorun.sh -n 1 /lustre/fsw/portfolios/llmservice/users/kevinhu/works/mod_speech_llm/code/NeMo_s2s_duplex2/scripts/speech_data_generation/source_align/run_nfa_anteater.sh