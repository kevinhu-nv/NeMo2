...
#SBATCH -J "convai_convaird_nemo-speech:topic_nfa"
...
manifest_dir=${root_dir}/topic_v2/Meta-Llama-3.1-70B-Instruct/shar_duplex/source_align/manifest_$(printf "%06d" ${manifest_index})
