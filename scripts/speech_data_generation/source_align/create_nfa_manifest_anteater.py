...
def parse_args():
    ...
    # parser.add_argument("--in_shar_dir", default="/lustre/fsw/portfolios/llmservice/projects/llmservice_nemo_speechlm/data/duplex/340b_8.19_daring_anteater_synth_v2_prompts_8801rm3.7p")
    # parser.add_argument("--output_audio_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/340b_8.19_daring_anteater_synth_v2_prompts_8801rm3.7p/shar_duplex/recording")
    # parser.add_argument("--output_manifest_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/340b_8.19_daring_anteater_synth_v2_prompts_8801rm3.7p/shar_duplex")
    parser.add_argument("--in_shar_dir", default="/lustre/fsw/portfolios/llmservice/projects/llmservice_nemo_speechlm/data/duplex/340b_8.19_daring_anteater_lmsys_sft_8801rm3.7p")
    parser.add_argument("--output_audio_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/340b_8.19_daring_anteater_lmsys_sft_8801rm3.7p/shar_duplex/recording")
    parser.add_argument("--output_manifest_dir", default="/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/340b_8.19_daring_anteater_lmsys_sft_8801rm3.7p/shar_duplex")
