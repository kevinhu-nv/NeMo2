...
# #SBATCH -J "convai_convaird_nemo-speech-speechllm:data_duplex_single_turn_asr"
#SBATCH -p cpu_short
...
#SBATCH -J "llmservice_nemo_speechlm:data_duplex_single_turn_asr"

set -x

CODE_DIR=/lustre/fs12/portfolios/llmservice/users/kevinhu/works/mod_speech_llm/code/NeMo_s2s_duplex2/scripts/speech_data_generation/asr_data
...
dataset_name=MMLPC
root_dir=/lustre/fsw/portfolios/llmservice/projects/llmservice_nemo_speechlm/data/ASR/MMLPC/en/tarred_train/
# root_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/duplex/${dataset_name}
# target_tar_dir=${root_dir}
source_tar_dir=${root_dir}

input_manifest_dir=${root_dir}/timestamp
# out_dir=${root_dir}/shar
out_dir=/lustre/fsw/portfolios/llmservice/projects/llmservice_nemo_speechlm/data/duplex/kevinhu/ASR/MMLPC/en/tarred_train/
RESULTS_DIR=${out_dir}/log
mkdir -p $RESULTS_DIR


CONTAINER=/lustre/fsw/portfolios/llmservice/users/zhehuaic/containers/nemo_s2s_24.08zhc.sqsh
MOUNTS="--container-mounts=/lustre/fsw:/lustre/fsw,${RESULTS_DIR}:${RESULTS_DIR},${CODE_DIR}:${CODE_DIR},${root_dir}:${root_dir},/lustre/fsw/portfolios/llmservice/users/kevinhu/results/HFCACHE/:/hfcache/,${input_manifest_dir}:${input_manifest_dir},${out_dir}:${out_dir},${source_tar_dir}:${source_tar_dir}"
...
&& HYDRA_FULL_ERROR=1 TORCH_CUDNN_V8_API_ENABLED=1 python -u -B ${CODE_DIR}/create_shars_from_single_turn_asr.py \
