...
# API="nv_oneapi"
API_KEY=$(cat /lustre/fsw/portfolios/llmservice/users/kevinhu/HFCACHE/zh_openai_key.txt)
API="openai"
...
CODE_DIR=/lustre/fsw/portfolios/llmservice/users/kevinhu/eval-intelligence
