...
log_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/code/s2s_pretrain_from_cc_20251003/exp_qwen7b/Qwen2.5-7B_SFT_adapter200m_from_step-27399-last_64gpu_5e-5_SFT0.1_TEXT0.1_QA0.02_t2t_loss0.0/results/inf/infer_qwen_7b_step_33407/validation_logs
...
cat ${log_dir}/metadatas/demo_rank{0..7}.json > $jsonl_with_timestamp
...
validation_set_name="demo"
eval_conv "--verbose --jsonl_with_timestamp $jsonl_with_timestamp --vad_min_silence_duration_ms $vad_min_silence_duration_ms --agent_binary_audio"
