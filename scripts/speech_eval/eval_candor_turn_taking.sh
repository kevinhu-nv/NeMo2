...
# EXP_NAME=f2f-test
# pred_audio_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/s2s/results/${EXP_NAME}/validation_logs/pred_wavs/

# EXP_NAME=DFW_qwen_1b_and_candor_4nodes_repro_recipe2_cft_0829
# EXP_NAME=DFW_qwen_1b_4nodes_repro_recipe2_newae_kevincd
EXP_NAME=demo_ckpt
pred_audio_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/s2s/exp/${EXP_NAME}/inf/validation_logs/pred_wavs/
