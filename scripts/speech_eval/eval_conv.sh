...
# EXP_NAME=DFW_qwen_1b_convasr_joint_4nodes_left8_asrl3_txtl3_et12_eb2
EXP_NAME=$1
CKPT_NAME=$2

# log_dir=/lustre/fsw/portfolios/llmservice/users/kevinhu/s2s/exp/${EXP_NAME}/inf/${CKPT_NAME}/validation_logs
log_dir=/lustre/fsw/portfolios/convai/users/kevinhu/s2s/exp/${EXP_NAME}/inf_all/${CKPT_NAME}/validation_logs
