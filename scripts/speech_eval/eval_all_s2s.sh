...
# boost_name=${2:-"pad0_bos0_eos0"}
boost_name=${2:-"pad-0.5_bos0.5_eos0"}
# boost_name=${2:-"pad-1.5_bos0.5_eos0.5"}

inf_dir=$ckpt_dir/fdb/${boost_name}/validation_logs
...
# VB
inf_dir=${ckpt_dir}/vb/${boost_name}/validation_logs
