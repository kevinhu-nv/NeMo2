...
json_output='/lustre/fsw/portfolios/convai/users/kevinhu/s2s/exp/DFW_qwen_1b_and_candor_vv_4nodes_repro_recipe2_cvvft/inf_train/validation_logs/metadatas/candor.json'
json_output='/lustre/fsw/portfolios/convai/users/kevinhu/s2s/exp/DFW_qwen_1b_and_candor_fp_4nodes_repro_recipe2_fpcft/inf/validation_logs/metadatas/candor.json'
json_output='/lustre/fsw/portfolios/convai/users/kevinhu/s2s/exp/DFW_qwen_1b_and_candor_fp_4nodes_repro_recipe2_fppcft/inf/validation_logs/metadatas/candor.json'
