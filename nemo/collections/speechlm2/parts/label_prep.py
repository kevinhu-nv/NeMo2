...
def prepare_labels(
    ...
    Args:
        ...
        target_codes: Encoded target audio codes (B, T, K)
    ...
    Returns:
        dict: Dictionary containing:
            ...
            - audio_inputs: Audio input codes (B, T-1, K)
            - audio_labels: Audio label codes (B, T-1, K)
    ...
    if predict_user_text:
        ...
        if cfg.get("allow_user_text_in_agent_turn", False):
            ...
            if asr_inputs.shape[1] != text_inputs.shape[1]:
                import pdb; pdb.set_trace()
            if text_inputs.shape[1] != audio_inputs.shape[1]:
                import pdb; pdb.set_trace()
